...
export default {
  ...
  methods: {
    ...
    async sendDocument() {
      ...
      console.log(elHtml)
      try {
        const { data } = await axios.post('https://roky.rocks/doc-editor/api/postDocument', { document: elHtml, filename: this.docData.filename ? this.docData.filename : 'templateName' }, {
          headers: {
